...
// @Name: image-width
// @Desc: Returns the width of the given image
// @Param:      img     - -   - The image to return the width of
// @Returns:    result  - -   - Width of the image
func imageWidth(img *image.NRGBA64) (int, error) { return img.Bounds().Max.X, nil }

// @Name: image-height
// @Desc: Returns the height of the given image
// @Param:      img     - -   - The image to return the height of
// @Returns:    result  - -   - Width of the image
func imageHeight(img *image.NRGBA64) (int, error) { return img.Bounds().Max.Y, nil }
...
func imageAspectRatio(img *image.NRGBA64) (float64, error) {
	return float64(img.Bounds().Max.X) / float64(img.Bounds().Max.Y), nil
}
